<#
This script is used to generate a function for the sig_gen.sh script, translating a syscall name to a numeric ID.

This script requires one source file from the Linux kernel.
Infile: /arch/x86/include/asm/unistd_xx.h (xx = 32 / 64)

The Outfile is the location of the generated bash file containing the function needed for sig_gen.sh.
#>
