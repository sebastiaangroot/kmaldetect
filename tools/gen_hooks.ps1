<#
This script requires four source files from the Linux kernel.
- InUnistd: /arch/x86/include/asm/unistd_xx.h (xx = 32 / 64)
- InSysGen: /include/linux/syscalls.h
- InSysArchGen: /include/asm-generic/syscalls.h
- InSysArch: /arch/x86/include/asm/syscalls.h

The Outfile is the location of the generated hooks.c file for use in the KMaldetect LKM.
#>
