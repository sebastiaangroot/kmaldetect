...
def usage():
	print('Usage: %s -o <outfile> -i <strace file>' % sys.argv[0])
	print('\t-o <signature>:\tThe location of the output signature file')
	print('\t-i <strace file>:\tThe location of the strace output file')
...
try:
	...
	if outfile == None or infile == None:
		raise getopt.GetoptError('No out- or infile supplied')
